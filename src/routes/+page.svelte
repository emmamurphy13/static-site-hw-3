...
<div class="container">
  ...
  <Image
    ...
    alt="Students just like the ones in Coding The News."
    caption="Students just like the ones in Coding The News."
  ...
  <ArticleBody>
    <p>
    Niya Doyle, Macy Hanzlik-Barend, Sophie Hayssen, Nancy Jiang, Irene Adeline Milanez, Ashley Mowreader, Emma Murphy, Chloe Rogers, Sidney Slon, Jack Walker, and Chrissy Wang.
    </p>
